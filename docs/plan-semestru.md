...
| 5 | Pętle | `02-sterowanie-i-petle/03-07` | Mini-sprawdzian segmentu `02` albo ćwiczenie min/max/średnia. | Student pisze pętlę bez ryzyka pętli nieskończonej. |
...
| 7 | Tablice i napisy | `03-funkcje-tablice-napisy/03-07` | Mini-sprawdzian segmentu `03` albo szyfr GADERYPOLUKI. | Student przetwarza tablicę i napis w pętli. |
...
| 11 | Dziedziczenie, operatory i STL | `06-oop/05-08`, `07-stl-struktury-danych/01-03` | Zadanie z wektorem obiektów i sortowaniem albo figury i polimorfizm. | Student używa `std::vector` oraz `std::sort`. |
...
| 13 | Organizacja projektu, build i testy | `08-projekt-build-testy` | Przygotować szkielet projektu albo kalkulator RPN z testami. | Projekt buduje się skryptem lub jedną opisaną komendą. |
...
## Ćwiczenia pomostowe w planie

Ćwiczenia pomostowe nie muszą zastępować mini-sprawdzianów. Można ich użyć jako:

- zadania domowego dla osób, które potrzebują większej praktyki,
- pracy na lekcji dla grupy, która szybko kończy zadania podstawowe,
- przygotowania do projektu zaliczeniowego,
- alternatywy dla mini-sprawdzianu, jeśli prowadzący woli ocenę praktyczną.

Proponowane miejsca:

- tydzień 5 - [minimum, maksimum i średnia](../02-sterowanie-i-petle/07-cwiczenie-min-max-srednia.md),
- tydzień 7 - [szyfr GADERYPOLUKI](../03-funkcje-tablice-napisy/07-cwiczenie-szyfr-gaderypoluki.md),
- tydzień 11 - [figury i polimorfizm](../06-oop/08-cwiczenie-figury-polimorfizm.md),
- tydzień 13 - [kalkulator RPN](../08-projekt-build-testy/09-cwiczenie-kalkulator-rpn.md).
