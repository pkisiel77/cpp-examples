...
- kalkulator pobiera wartości i działania matematyczne następnie  wylicza po naciśnięciu = (np.: 2 + 2 * 2 = 6), brak ograniczenia w liczbie parametrów działania (np..: http://pl.wikipedia.org/wiki/Odwrotna_notacja_polska).
